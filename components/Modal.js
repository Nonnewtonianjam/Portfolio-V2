...
const Modal = ({visible, children, onClose}) => {
  ...
  return (
    <div 
        ...
        <div className={`relative flex h-4/5 lg:h-3/5 md:w-2/3 lg:w-1/2 items-center bg-white dark:bg-black p-2 rounded  overflow-auto ${visible === true ? 'modal active' : 'modal'}`}>
            {children}
