...
const Modal = ({visible, children, onClose}) => {
  ...
  return (
    <div 
        ...
        <div className={`relative flex h-full lg:h-2/3 md:w-2/3 lg:w-3/5 items-center bg-white dark:bg-black p-2 rounded  overflow-auto ${visible === true ? 'modal active' : 'modal'}`}>
            {children}
